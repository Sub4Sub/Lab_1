...
(function()
{
    ...
    */
    ...
    function Start()
    {
        ...
        let productsButton = document.getElementById("headerList");
      ...
      `
      <li class="nav-item">
        <a class="nav-link" id="HumanResourcesLink" aria-current="page" href="human-resources.html"><i class="fas fa-globe fa-lg"></i> Humassn Resources</a>
      </li>
      `

       productsButton.replaceChild(newListItem, productsButton);
